...
* `--include-classes`: Treat classes as packages and provide per-class method counts. One use-case is protocol buffers where all generated code in a package ends up in a single class.
* `--include-detail`: Output include each method.
